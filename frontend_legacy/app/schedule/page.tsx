...
const CALENDAR = [
    { round: 1, name: "FORMULA 1 QATAR AIRWAYS AUSTRALIAN GRAND PRIX 2026", date: "06 - 08 Mar", location: "Australia", status: "Completed" },
    { round: 2, name: "FORMULA 1 HEINEKEN CHINESE GRAND PRIX 2026", date: "13 - 15 Mar", location: "China", status: "Completed" },
    { round: 3, name: "FORMULA 1 ARAMCO JAPANESE GRAND PRIX 2026", date: "27 - 29 Mar", location: "Japan", status: "Completed" },
    { round: 4, name: "FORMULA 1 CRYPTO.COM MIAMI GRAND PRIX 2026", date: "01 - 03 May", location: "Miami", status: "Upcoming" },
    { round: 5, name: "FORMULA 1 LENOVO GRAND PRIX DU CANADA 2026", date: "22 - 24 May", location: "Canada", status: "Upcoming" },
    { round: 6, name: "FORMULA 1 LOUIS VUITTON GRAND PRIX DE MONACO 2026", date: "05 - 07 Jun", location: "Monaco", status: "Upcoming" },
    { round: 7, name: "FORMULA 1 MSC CRUISES GRAN PREMIO DE BARCELONA-CATALUNYA 2026", date: "12 - 14 Jun", location: "Barcelona-Catalunya", status: "Upcoming" },
    { round: 8, name: "FORMULA 1 LENOVO AUSTRIAN GRAND PRIX 2026", date: "26 - 28 Jun", location: "Austria", status: "Upcoming" },
    { round: 9, name: "FORMULA 1 PIRELLI BRITISH GRAND PRIX 2026", date: "03 - 05 Jul", location: "Great Britain", status: "Upcoming" },
    { round: 10, name: "FORMULA 1 MOËT & CHANDON BELGIAN GRAND PRIX 2026", date: "17 - 19 Jul", location: "Belgium", status: "Upcoming" },
    { round: 11, name: "FORMULA 1 AWS HUNGARIAN GRAND PRIX 2026", date: "24 - 26 Jul", location: "Hungary", status: "Upcoming" },
    { round: 12, name: "FORMULA 1 HEINEKEN DUTCH GRAND PRIX 2026", date: "21 - 23 Aug", location: "Netherlands", status: "Upcoming" },
    { round: 13, name: "FORMULA 1 PIRELLI GRAN PREMIO D'ITALIA 2026", date: "04 - 06 Sep", location: "Italy", status: "Upcoming" },
    { round: 14, name: "FORMULA 1 TAG HEUER GRAN PREMIO DE ESPAÑA 2026", date: "11 - 13 Sep", location: "Spain", status: "Upcoming" },
    { round: 15, name: "FORMULA 1 QATAR AIRWAYS AZERBAIJAN GRAND PRIX 2026", date: "24 - 26 Sep", location: "Azerbaijan", status: "Upcoming" },
    { round: 16, name: "FORMULA 1 SINGAPORE AIRLINES SINGAPORE GRAND PRIX 2026", date: "09 - 11 Oct", location: "Singapore", status: "Upcoming" },
    { round: 17, name: "FORMULA 1 MSC CRUISES UNITED STATES GRAND PRIX 2026", date: "23 - 25 Oct", location: "United States", status: "Upcoming" },
    { round: 18, name: "FORMULA 1 GRAN PREMIO DE LA CIUDAD DE MÉXICO 2026", date: "30 Oct - 01 Nov", location: "Mexico", status: "Upcoming" },
    { round: 19, name: "FORMULA 1 MSC CRUISES GRANDE PRÊMIO DE SÃO PAULO 2026", date: "06 - 08 Nov", location: "Brazil", status: "Upcoming" },
    { round: 20, name: "FORMULA 1 HEINEKEN LAS VEGAS GRAND PRIX 2026", date: "19 - 21 Nov", location: "Las Vegas", status: "Upcoming" },
    { round: 21, name: "FORMULA 1 QATAR AIRWAYS QATAR GRAND PRIX 2026", date: "27 - 29 Nov", location: "Qatar", status: "Upcoming" },
    { round: 22, name: "FORMULA 1 ETIHAD AIRWAYS ABU DHABI GRAND PRIX 2026", date: "04 - 06 Dec", location: "Abu Dhabi", status: "Upcoming" },
];
